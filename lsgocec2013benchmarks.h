...
void rotateVectorConflict(int i, int c, double *anotherz, double *anotherz1, int *Pvector, double **OvectorVec, int *s, double **r25, double **r50, double **r100, int overlap, int dim)  овекторвек
{
	double* z = new double[s[i]];
